...
public class StockmanTestContainer extends TestContainer {

    public StockmanTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/stockman/app.properties",
    ...
    public static class Common extends StockmanTestContainer {

        public static final StockmanTestContainer.Common INSTANCE = new StockmanTestContainer.Common();
